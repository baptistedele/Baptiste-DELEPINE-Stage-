...
class MinimalPublisher(Node):# Création de la classe Noeud publisher 
    ...
    def timer_callback(self):
        ...
        self.get_logger().info('Publishing: "%s"' % msg.data) # permet d'avoir des logins messages. Autrement dit cela permet d'être informer sur le déroulement de l'envoi du message
